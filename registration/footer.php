<!-- special offers -->
	...
	<footer>
		<div class="container">
			...
			<p class="footer-main">
				<span>"Kokan Crunchy"</span> Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur
			...
			<div class="footer-info w3-agileits-info">
				...
				<div class="col-sm-5 address-right">
					...
					<div class="col-xs-6 footer-grids">
						...
						<ul>
							<li>
								<i class="fa fa-map-marker"></i> Mumbai, Maharashtra, India.</li>
							<li>
								<i class="fa fa-mobile"></i> +91 98212 36048 </li>
							<li>
				...
				<div class="col-sm-2 footer-grids  w3l-socialmk">
					...
					<div class="social">
						<ul>
							<li>
								<a class="icon fb" href="https://www.facebook.com/KokanCrunchy023" target="_blank">
	...
	<div class="copy-right">
		<div class="container">
			<p>© 2020 Kokan Crunchy. All rights reserved <!-- | Design by
				<a href="http://amitkduiuxdesigner.co.in/"> Amit Kadu UI Developer.</a>-->
			</p>
		</div>
	</div>
	<!-- //copyright -->
    
    <div hidden id="snipcart" data-api-key="Mzc2Mzc1YWItMmFkNi00MmU4LTliMjMtMjA3ODQzN2M1MGMzNjM3Mzk1NTYwMjc1ODg5Njk0"  data-currency="inr" ></div>
